"""
Bootstrap the June 20 sharp-window baseline-demand AIPTW ATT.
...
def main() -> None:
    args = parse_args()
    config = make_config(
        estimand="NYC June 20 sharp-window ATT with station-hour baseline demand controls",
        station_weighted=False,
        input_path=INPUT_PATH,
        results_dir=RESULTS_DIR,
        output_stem="june_20_baseline_demand_bootstrap",
    ...
    out = RESULTS_DIR / "june_20_baseline_demand_bootstrap_summary.csv"
