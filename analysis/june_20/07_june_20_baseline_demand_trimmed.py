"""
Run the June 20 baseline-demand specification with propensity trimming.

This matches the pooled June 20 baseline-demand AIPTW specification except
...
def main() -> None:
    config = make_config(
        estimand="NYC June 20 sharp-window ATT with baseline demand controls and propensity trimming",
        station_weighted=False,
        input_path=INPUT_PATH,
        results_dir=RESULTS_DIR,
        output_stem="june_20_baseline_demand_trimmed",
        t0_start="2025-05-23",
    ...
    result["sensitivity"] = "june_20_baseline_demand_trimmed"
    ...
    result_path = RESULTS_DIR / "june_20_baseline_demand_trimmed_summary.csv"
    diagnostics_path = RESULTS_DIR / "june_20_baseline_demand_trimmed_city_diagnostics.csv"
