"""
Bootstrap the June 20 no-baseline e-bike ATT excluding Chicago.

Window: May 23-June 19, 2025 versus June 20-July 17, 2025. Outcome:
ebike_trip_count at the paired station-hour level. Controls are Boston,
Philadelphia, and Washington DC. Chicago is excluded because the June 2025
Divvy station ID change creates false zeros in the early pre-window panel.
"""
...
def main() -> None:
    args = parse_args()
    config = make_config(
        estimand="NYC June 20 ATT excluding Chicago with weather and time-slot controls",
        station_weighted=False,
        input_path=INPUT_PATH,
        results_dir=RESULTS_DIR,
        output_stem="june_20_no_chicago_bootstrap",
    ...
    out = RESULTS_DIR / "june_20_no_chicago_bootstrap_summary.csv"
